<template>
    ...
    <el-dialog v-model="dialogFormVisible" :title="props.title" :width="300">
        <el-input v-model="formData.name" placeholder="Ingrese el nombre del nivel" clearable></el-input>
...
import { sendData, updateData } from "@/modules/cruds/levels/services/ApiLevels.js";
